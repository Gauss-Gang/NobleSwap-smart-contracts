...
export interface ScheduledTokenLockInterface extends utils.Interface {
  functions: {
...
export interface ScheduledTokenLock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ScheduledTokenLockInterface;
