...
export interface GTS20Snapshot_UPGInterface extends utils.Interface {
  functions: {
...
export interface GTS20Snapshot_UPG extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GTS20Snapshot_UPGInterface;
